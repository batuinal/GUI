...
public class SongSelectFrame extends JFrame
{
	...
	private JTextField searchField; // need for later to possibly search over a song? 
...
//		searchPanel.add (new JLabel("Search for a song: "), SwingConstants.CENTER);
//		songPanel.add(searchPanel); 
	...
	public class SongSelectListener implements ActionListener
	{
		public void actionPerformed (ActionEvent e)
		{
			...
			else if (e.getSource() == backButton){ // backButton clicked
